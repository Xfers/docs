...
bank_unique_amt | Random very small amount generated by Xfers.
bank_discount | This is the amount user should use to transfer to the bank. (total - bank_unique_amt)
